...
export default TaskItem = (props) => {
    ...
    const priorityColor = (state) => {
        switch(state) {
            ...
            case 'default': return priority.default
    ...
    return (
        <View style={styles.container}>
            <View style={[styles.taskContainer, {backgroundColor: theme.background, borderColor: priorityColor(priorityState)}]}>
                <TouchableOpacity onPress={() => props.markTask()} >
                    <View style={[styles.square,{backgroundColor: priorityColor(priorityState)}]}>
                    {
